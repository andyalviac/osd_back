...
class LocationStub(object):
    ...
    def __init__(self, channel):
        ...
        """
        self.GetLocationDataById = channel.unary_unary(
            "/location.Location/GetLocationDataById",
...
class LocationServicer(object):
    ...
    def GetLocationDataById(self, request, context):
...
def add_LocationServicer_to_server(servicer, server):
    rpc_method_handlers = {
        "GetLocationDataById": grpc.unary_unary_rpc_method_handler(
            servicer.GetLocationDataById,
